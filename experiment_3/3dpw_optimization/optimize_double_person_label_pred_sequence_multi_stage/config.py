...
class opt(object):
    ...
    if global_pose_consistency_weight > 0 and num_img > 1:
        exp_name += '_gpc_%g' % global_pose_consistency_weight
    if body_pose_consistency_weight > 0 and num_img > 1:
        exp_name += '_bpc_%g' % body_pose_consistency_weight
    if transl_consistency_weight > 0 and num_img > 1:
        exp_name += '_trc_%g' % transl_consistency_weight
