...
def main():
    ...
    filename_ref = os.path.join(abspath, 'data/example2_ref.png')
    ...
    for i in loop:
        ...
        cv2.imshow('Optimize', (image*255).astype(np.uint8))
        cv2.waitKey(100)
    ...
    for num, azimuth in enumerate(loop):
        ...
        cv2.imshow('mesh', (image*255).astype(np.uint8))
        cv2.waitKey(100)
